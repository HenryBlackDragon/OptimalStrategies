...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        float[][] vectorFirst = vectorDifference(val.getFirst().getVectorQ(), firstVectorG());
        float[][] vectorSecond = vectorDifference(val.getSecond().getVectorQ(), firstVectorG());
        float[][] vectorThird = vectorDifference(val.getThird().getVectorQ(), firstVectorG());
        float[][] vectorFourth = vectorDifference(val.getFourth().getVectorQ(), firstVectorG());
        float[][] vectorFive = vectorDifference(val.getFive().getVectorQ(), firstVectorG());
        float[][] vectorSix = vectorDifference(val.getSix().getVectorQ(), firstVectorG());
        ...
        check(firstChooseOptimalStrategy(), list).forEach(System.out::println);
